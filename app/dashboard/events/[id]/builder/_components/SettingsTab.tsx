...
const s = {
  ...
  cardTitle: { fontSize: "0.8125rem", fontWeight: 600, color: "var(--c-muted)", textTransform: "uppercase" as const, letterSpacing: "0.05em", marginBottom: "0.875rem" },
  ...
  linkNote: { margin: 0, color: "var(--c-muted)", fontSize: "0.875rem" },
  noHosting: { padding: "0.75rem", background: "#fef9c3", borderRadius: "8px", fontSize: "0.875rem", color: "#854d0e" },
  publishRow: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: "1rem", flexWrap: "wrap" as const },
  publishLabel: { fontSize: "0.9375rem", fontWeight: 600, color: "var(--c-text)" },
  publishSub: { fontSize: "0.8125rem", color: "var(--c-muted)", marginTop: "0.125rem" },
  toggleBtn: {
    padding: "0.5rem 1rem",
    border: "none",
    borderRadius: "7px",
  ...
  publishBtn: { background: "var(--c-accent)", color: "#fff" },
  unpublishBtn: { background: "var(--c-surface-2)", color: "var(--c-text)" },
  ...
  wmNote: { fontSize: "0.8125rem", color: "var(--c-muted)" },
} as const;
