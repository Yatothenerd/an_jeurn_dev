...
const s = {
  ...
  addBtn: { padding: "0.5rem 1rem", background: "var(--c-accent)", color: "var(--c-lime-text)", border: "none", borderRadius: "7px", cursor: "pointer", fontSize: "0.875rem", fontWeight: 600 },
  saveBtn: { padding: "0.5rem 1rem", background: "var(--c-accent)", color: "var(--c-lime-text)", border: "none", borderRadius: "7px", cursor: "pointer", fontSize: "0.875rem", fontWeight: 600, flexShrink: 0 },
